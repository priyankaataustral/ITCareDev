...
export default function AgentsPage({ open, onClose }) {
  ...
  useEffect(() => {
    if (open && canManageAgents) {
      loadData();
    }
  }, [open, canManageAgents]);
  ...
  }, [departmentFilter, open, canManageAgents]);
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="pt-3 border-t border-gray-100">
                      <div className="grid grid-cols-2 gap-4 text-center">
                        <div>
                          <div className="text-lg font-bold text-blue-600">{agent.stats?.total_tickets || 0}</div>
                          <div className="text-xs text-gray-500">Total Tickets</div>
                        </div>
                        <div>
                          <div className="text-lg font-bold text-green-600">{agent.stats?.resolution_rate || 0}%</div>
                      ...
                      <div className="mt-3 grid grid-cols-2 gap-4 text-center">
                        <div>
                          <div className="text-sm font-medium text-gray-700">{agent.stats?.resolved_tickets || 0}</div>
                          <div className="text-xs text-gray-500">Resolved</div>
                        </div>
                        <div>
                          <div className="text-sm font-medium text-gray-700">{agent.stats?.recent_activity || 0}</div>
